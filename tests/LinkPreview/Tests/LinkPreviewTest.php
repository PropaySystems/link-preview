...
namespace Propay\LinkPreview\Tests;
...
class LinkPreviewTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $generalParserMock = $this->getMock('Propay\LinkPreview\Parsers\HtmlParser', null);
        $youtubeParserMock = $this->getMock('Propay\LinkPreview\Parsers\YouTubeParser', null);
    ...
    {
        $linkMock = $this->getMock('Propay\LinkPreview\Models\Link', null, ['http://www.google.com']);

        $generalParserMock = $this->getMock('Propay\LinkPreview\Parsers\HtmlParser');
        $previewMock = $this->getMock('Propay\LinkPreview\Models\HtmlPreview');
    ...
    public function can_parse_a_youtube_link()
    {
        ...
        self::assertInstanceOf('Propay\LinkPreview\Models\VideoPreview', $parsedLink);
    }
}
